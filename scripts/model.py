...
class Model:
    ...
    def predict(self, code):
        ...
        # predict with model
        prediction = model.predict(self.code)
        # inverse_transform the result
...
def train_model(model: Model,
    ...
    # TODO Discuss: should we use verbose = 0 and monitor?
